        ...
        <div className="col-12 col-lg-8">
          <div className="card shadow-sm border-0">
            <div className="card-body text-center">
              ...
              <div className="mt-4">
                {accepted ? (
                  <div className="alert alert-success mb-0 text-muted">Thank you! You have accepted the terms.</div>
                ) : (
                  <div className="alert alert-warning mb-0 text-muted">please! read accept our terms.</div>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="modal-dialog modal-xl modal-dialog-centered">
          <div className="modal-content shadow-lg">
            <div className="modal-header border-bottom-0">
              <div>
                <h5 className="modal-title text-primary fw-bold" id="termsModalLabel">Terms and Conditions</h5>
